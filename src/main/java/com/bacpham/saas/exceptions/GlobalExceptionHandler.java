...
import com.bacpham.saas.exceptions.responses.ErrorResponse;
...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<ErrorResponse> handleException(
                ...
                ex.getBindingResult()
                                ...
                                .forEach(error -> {
                                        ...
                                        final String defaultMessage = error.getDefaultMessage(); // todo add translation
                                                                                                 // later
        ...
        public ResponseEntity<ErrorResponse> handleException(
                        ...
                        final HttpServletRequest request) {
                log.error("Authentication service exception occurred", ex);
